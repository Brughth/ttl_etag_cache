...
void main() {
  final NeeroTtlEtagCachePlatform initialPlatform =
      NeeroTtlEtagCachePlatform.instance;
  ...
  test('getPlatformVersion', () async {
    TtlEtagCache neeroTtlEtagCachePlugin = TtlEtagCache();
    MockNeeroTtlEtagCachePlatform fakePlatform =
        MockNeeroTtlEtagCachePlatform();
